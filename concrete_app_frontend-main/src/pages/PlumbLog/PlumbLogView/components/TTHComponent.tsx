                    ...
                    <div className='leftMainBlock df fdc' style={{gap: '5px', width: '80%'}}>
                        ...
                        <div className='df fdr'>
                            <div className='df fdr' style={{gap: '10px'}}>
                                ...
                                <span className='underline-extended-first'><strong>{weighData?.client_company_type} {weighData?.client_company}</strong></span>
                            </div>
                        </div>
                ...
                <table className="truckTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><strong>{weighData?.bag_details || '-'}</strong></td>
                            <td></td>
                            <td></td>
